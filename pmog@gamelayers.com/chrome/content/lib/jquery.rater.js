...
jQuery.fn.rater = function(url, options)
 {
    ...
    // i am using find here, because the span wrapped in the small style would break children()
    if (settings.maxvalue > 1)
    // add a container for the ajax result
    {
    ...
    stars.click(function()
    {
        ...
        else
        {
            ...
            jQuery('portalrating')[0].rate(raterValue);
    ...
    return this;
    // strict warning: anonymous function does not always return a value. fix?
